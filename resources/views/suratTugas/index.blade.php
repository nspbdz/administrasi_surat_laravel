            ...
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card" style="width: 100%;">
                    <div class="card-header">
                        ...
                        <a href="{{route('suratTugas.create')}}" class="btn btn-primary"><i class="fas fa-plus-square"></i>&nbsp;&nbsp;&nbsp;Tambah</a>
                        @endcan
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered" id="suratTugas">
                            <thead>
                                <tr>
                                    <th width="3%">No</th>
                                    <th>No. Surat</th>
...
<script>
    $(document).ready(function() {
        swal("Surat Tugas berhasil di tambahkan!", {
            icon: "success",
        })
    })
</script>
...
<script>
    $(document).ready(function() {
        swal("Surat Tugas Berhasil di edit!", {
            icon: "success",
        })
    })
</script>
...
<script>
    $(document).ready(function() {
        let suratTugas = $('#suratTugas').DataTable({
            processing: true,
            serverside: true,
            // responsive: true,
            ajax: {
                url: "{{route('getSuratTugas')}}",
                data: function(data) {
                    data.awal = $('#awal').val();
