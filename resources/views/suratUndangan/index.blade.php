            ...
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card" style="width: 100%;">
                    <div class="card-header">
                        @can('surat_undangan-create')
                        <a href="{{route('suratUndangan.create')}}" class="btn btn-primary"><i class="fas fa-plus-square"></i>&nbsp;&nbsp;&nbsp;Tambah</a>
                        @endcan
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered" id="suratUndangan">
                            <thead>
                                <tr>
                                    <th width="3%">No</th>
                                    <th>No. Surat</th>
...
<script>
    $(document).ready(function() {
        swal("Surat Undangan berhasil di tambahkan!", {
            icon: "success",
        })
    })
</script>
...
<script>
    $(document).ready(function() {
        swal("Surat Undangan Berhasil di edit!", {
            icon: "success",
        })
    })
</script>
...
<script>
    $(document).ready(function() {
        let suratUndangan = $('#suratUndangan').DataTable({
            processing: true,
            serverside: true,
            // responsive: true,
            ajax: {
                url: "{{route('getSuratUndangan')}}",
                data: function(data) {
                    data.awal = $('#awal').val();
        ...
        $('#btnFilter').click(function(e) {
            e.preventDefault()
            suratUndangan.ajax.reload();
        })
    });


    function deleteSuratUndangan(id) {
        console.log(id)
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        url: "/suratkeluar/suratUndangan/" + id,
                        method: "DELETE",
                        headers: {
