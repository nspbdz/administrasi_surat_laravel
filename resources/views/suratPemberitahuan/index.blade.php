            ...
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card" style="width: 100%;">
                    <div class="card-header">
                        @can('surat_pemberitahuan-create')
                        <a href="{{route('suratPemberitahuan.create')}}" class="btn btn-primary"><i class="fas fa-plus-square"></i>&nbsp;&nbsp;&nbsp;Tambah</a>
                        @endcan
                    </div>
                        ...
                        <form action="#" id="filterPrice">
                            <div class="row">
                                ...
                                <div class="d-flex col-xl-3 col-md-3 align-items-center mt-4 gap-2">
                                    <button type="button" class="btn btn-primary" id="btnFilter1"><i data-feather='filter'></i>&nbsp;Filter</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    $(document).ready(function() {
        swal("Surat Pemberitahuan Berhasil di tambahkan!", {
            icon: "success",
        })
    })
</script>
...
<script>
    $(document).ready(function() {
        swal("Surat Pemberitahuan Berhasil di edit!", {
            icon: "success",
        })
    })
</script>
...
<script>
    $(document).ready(function() {
        ...
        let suratPemberitahuan = $('#suratPemberitahuan').DataTable({
            ...
            // responsive: true,
            ajax: {
                url: "{{route('getSuratPemberitahuan')}}",
                data: function(data) {
                    data.awal = $('#awal').val();
        ...
        $('#btnFilter1').click(function(e) {
            e.preventDefault()
            suratPemberitahuan.ajax.reload();
        })
    });
    ...
    function deleteSuratPemberitahuan(id) {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        url: "/suratkeluar/suratPemberitahuan/" + id,
                        method: "DELETE",
                        headers: {
